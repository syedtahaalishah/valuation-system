...
@section('content')
    <div class="container-fluid">
        <div class="card mb-4 shadow">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('admin.profile.update') }}" class="user" id="ajaxform">
                    @csrf
                    ...
                    <div class="form-group row">
                        <div class="col-sm-6 mb-sm-0 mb-3">
                            ...
                            <input type="text" name="name" id="name" class="form-control form-control-user"
                                placeholder="e.g., John" value="{{ auth()->user()->name }}">
                        </div>
                        <div class="col-sm-6 mb-sm-0 mb-3">
        ...
        <div class="card mb-4 shadow">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('admin.profile.password.update') }}" class="user" id="ajaxform2">
                    @csrf
